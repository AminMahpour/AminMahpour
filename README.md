...
I'm a computational biologist and biochemist based in Boston, MA. I build practical tools for biological data analysis, scientific visualization, and AI-assisted research workflows.

My work sits at the intersection of biology, software engineering, and data-intensive analysis. I am especially interested in tools that make complex biological datasets easier to explore, visualize, and reason about.

## Current Focus

- Computational biology and genomics tooling
- Scientific Python workflows for biological data analysis
- Data visualization for genomic tracks and biological signals
- Local-first AI agents for research and development workflows
- Reproducible, practical software for scientists
...
Python, bioinformatics workflows, genomics, RNA-seq, data visualization, LangChain, Chainlit, MCP, scientific computing, and research software development.

## Connect

- Website: [aminmahpour.com](https://aminmahpour.com)
- GitHub: [AminMahpour](https://github.com/AminMahpour)
- X/Twitter: [@Kavoshex](https://twitter.com/Kavoshex)
